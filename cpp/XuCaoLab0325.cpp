...
int main()
{
    ...
    while (i < size) {
        ...
        if (number < 0 || points < 0) {
            cout << "Play's number or points they scored was not valid. Please re-enter." << endl;
        }
        else {
    ...
    cout << "The name of the player who earned the most points is " << vipPlayer.getName() << " and his or her number is " << vipPlayer.getNumber() << endl;
