...
Student Find(char gender, Student students[], int student_size, FIRSTORLAST location)
{
	Student ret = {0, "Not found"};
...
int GetAgeCount(int age, Student students[], int student_size)
{
	// Fill in the logic to find
	return 0;
}
Student Find(float gpa, Student students[], int student_size, FIRSTORLAST location)
{
	Student ret = {0, "Not found"};
	// Fill in the logic to find
	return ret;
