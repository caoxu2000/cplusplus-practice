...
Student Find(int, Student[], int);
Student Find(string, Student[], int);
...
int main()
{
    ...
    while (true)
    {
        ...
        int studentID;
        string studentFName, studentLName, studentFullName;
        ...
        switch (response) {
            ...
            case 2:
                ...
                searchedStudent = Find(studentFullName, students, STUDENT_SIZE);
                if (searchedStudent.Id != 0) {
                    displayStudentArray(searchedStudent);
                } else {
                    cout << "Student with Student Name " << studentFullName << " Not found." << endl;
                }
                break;
            default:
                cout << "Wrong input!";
...
Student Find(int id, Student students[], int student_size)
{
    ...
    for (int index = 0; index < student_size; index++) {
