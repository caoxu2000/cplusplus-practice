...
void drawGallow(int wrongGuessCount) {// display picture based on wrong guess count
    ...
    switch (wrongGuessCount) {
        case 1:
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 5 more times of wrong guess." << endl << endl;
            break;
        case 2:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 4 more times of wrong guess." << endl << endl;
            break;
        case 3:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 3 more times of wrong guess." << endl << endl;
            break;
        case 4:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 2 more times of wrong guess." << endl << endl;
            break;
        case 5:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 1 more time of wrong guess." << endl << endl;
            break;
        case 6:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |Your Dead " << endl
            << "  ============" << endl << endl
            << "You have 0 more time of wrong guess." << endl << endl;
            break;
        default:
            cout << endl << endl
            << "   +----+     " << endl
            ...
            << "   |" << endl
            << "  ============" << endl << endl
            << "You have 6 times of wrong guess in total." << endl << endl;
    }
    return;
}
...
string selectSecret() { //read file; choose word
    ...
    word.pop_back(); // remove the last new line character since it is from a line of a file
...
void printGameState(int& wrongGuessCount, string guessState, string missedLetters, string word) {//Display function
    ...
    if (guessState == word) {//prints the winning message
        cout << "Yes! The secret word is \"" << word << "\"! You have won!" << endl;
    }
}
...
bool gameOver(const int wrongGuessCount, const string guessState, const string word) {//is the game over
    ...
    if (guessState == word) {// if user has guessed all the correct letters in the word
        isGameOver = true;//the game is over
    }
    return isGameOver;
}
